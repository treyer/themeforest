    ...
    <>
      ...
      <Typography variant="paragraph2_regular" color="gray" marginTop={30}>
        <TypographyP>
          ...
          <i>
            “Vivamus lectus enim, convallis nec dapibus vel, semper id ante.
            Morbi pulvinar sapien nulla, eu dignissim enim ullamcorper vitae”.
          </i>
        </TypographyP>
        <TypographyP>
          Ut sit amet neque vel mauris consequat aliquam at in arcu. Ut
          vulputate, augue luctus dignissim pretium, elit magna placerat elit,
          at venenatis lacus arcu eget quam. Fusce nec cursus mi, sed{" "}
          <TypographyA href="#">blandit</TypographyA>.
        </TypographyP>
        <TypographyP>
          ...
          tincidunt aliq uam ligula id, lacinia auctor orci. Sed quis lobortis
          eros. Fusce id commodo libero. Praesent mollis velit ac accumsan
          ultrices. Ut convallis ipsum pulvinar ante maximus suscipit.
        </TypographyP>
      </Typography>
      <Flex justify="end">
        <Typography
      ...
      <Typography variant="paragraph2_regular" color="gray">
        <TypographyP>
          ...
          Fusce feugiat elit facilisis volutpat venenatis.
          <Typography variant="paragraph2_bold">
            Vestibulum tempor ligula vel orci consectetur, eu euismod augue
            bibendum. In volutpat libero velit, et mattis tortor placerat eget.
          </Typography>
        </TypographyP>
        <TypographyP>
      ...
      <Flex justify="start" columnGap={32} width={520}>
        ...
        <Flex justify="start" columnGap={10}>
          ...
          <Icon url={ICON_URLS.LinkedIn} width={15} height={15} color="gray" />
          <Icon url={ICON_URLS.Facebook} width={15} height={15} color="gray" />
          <Icon url={ICON_URLS.Twitter} width={15} height={15} color="gray" />
          <Icon url={ICON_URLS.Google} width={15} height={15} color="gray" />
          <Icon url={ICON_URLS.Youtube} width={15} height={15} color="gray" />
        </Flex>
